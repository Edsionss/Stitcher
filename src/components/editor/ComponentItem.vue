<template>
  ...
  >
    <!-- 组件图标 -->
    <div class="flex items-center justify-center w-10 h-10 mx-auto mb-1.5 rounded-lg bg-slate-100 dark:bg-slate-800 group-hover:bg-primary/10 transition-colors">
      <span class="material-symbols-outlined text-xl text-slate-600 dark:text-slate-400 group-hover:text-primary transition-colors">
        {{ component.icon }}
      </span>
    </div>
    ...
    <div class="text-center">
      ...
      <div class="relative group/tooltip flex justify-center">
        <span class="material-symbols-outlined text-sm text-slate-400 dark:text-slate-500 cursor-help hover:text-slate-600 dark:hover:text-slate-300">
          info
        </span>
        <div class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-slate-900 dark:bg-slate-700 text-white text-xs rounded-md opacity-0 group-hover/tooltip:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none shadow-lg">
